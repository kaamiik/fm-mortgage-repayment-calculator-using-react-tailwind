  ...
  if (type === 'prefix')
    return (
      ...
      >
        ...
        <Group className="data-focus-within:border-lime group data-invalid:border-red grid grid-cols-[auto_1fr] rounded-sm border border-slate-500 transition-all duration-300 ease-in-out has-hover:border-slate-900 data-focus-visible:outline-2 data-focus-visible:outline-offset-2 data-focus-visible:outline-slate-900 data-focus-visible:outline-dotted">
